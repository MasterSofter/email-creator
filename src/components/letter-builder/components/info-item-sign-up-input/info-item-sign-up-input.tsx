...
import {InfoItemSignUpElement, LetterData, Stations,} from '../../../../types/types';
...
export default function InfoItemSignUpInput({element, letterData, setLetterData}: Props): JSX.Element {
    return (
        <FormGroup className=''>
            <div className='mb-3'>
                ...
                <div className='me-5'>
                    ...
                    <FormControl
                        ...
                        onChange={(event) => {
                            element.setValue({
                                ...element.getValue(),
                                periods: {...element.getValue().periods, 0: event.currentTarget.value}
                            })
                            setLetterData([...letterData]);
                        }}
                        required/>
                ...
                <div>
                    ...
                    <FormControl
                        ...
                        onChange={(event) => {
                            element.setValue({
                                ...element.getValue(),
                                periods: {...element.getValue().periods, 1: event.currentTarget.value}
                            })
                            setLetterData([...letterData]);
                        }}
                        required/>
