export default function Logo(props: { is_builtLetter: boolean }): JSX.Element {
    return (
      <table border={0} cellSpacing={0} cellPadding={0} width='100%' style={{borderCollapse:'collapse', padding:0,maxWidth:'600px', marginTop:'30px', marginBottom:'30px', marginLeft: 'auto' ,marginRight: 'auto'}}>
          <tbody>
