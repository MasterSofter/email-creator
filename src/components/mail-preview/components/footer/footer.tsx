                    ...
                    <div style={{display: 'flex', flexDirection:'row'}}>
                      ...
                      <div style={{display: 'inline-block', verticalAlign: 'top', width: '100%', maxWidth:'250px'}}>
                        <a href='tel:+79017130331' style={{display: 'block', color: 'rgb(0,0,0)', fontSize: '13px', lineHeight: '28px', fontWeight: 'normal', textAlign: 'right', textDecoration: 'none', paddingBottom: '0px'}}>
                          +7&nbsp;(901)&nbsp;713-03-31&nbsp;&nbsp;
                          <img src={props.is_builtLetter ? 'https://dev.mai.ru/services/email-creator-tr/images/_phone-flip.png' : process.env.PUBLIC_URL + '/images/_phone-flip.png'}
                    ...
                    <div style={{display: 'flex', flexDirection:'row'}}>
                      ...
                      <div style={{display: 'inline-block', verticalAlign: 'top', width: '100%', maxWidth:'250px'}}>
                        <a href='traektoria@mai.ru' style={{display: 'block', color: 'rgb(0,0,0)', fontSize: '13px', fontWeight: 'normal', textAlign: 'right', textDecoration: 'none', paddingBottom: '0px'}}>
                          traektoria@mai.ru&nbsp;&nbsp;
                          <img src={props.is_builtLetter ? 'https://dev.mai.ru/services/email-creator-tr/images/_envelope.png' : process.env.PUBLIC_URL + '/images/_envelope.png'}
                    ...
                    <div style={{display: 'inline-block', verticalAlign: 'top', width: '100%', maxWidth:'250px'}}>
                      <div style={{display: 'block', textAlign: 'right', verticalAlign:'bottom'}}>
                        <a href='https://t.me/traektoriamai' target='_blank'>
                          <img src={props.is_builtLetter ? 'https://dev.mai.ru/services/email-creator-tr/images/_telegram.png' : process.env.PUBLIC_URL + '/images/_telegram.png'}
                               alt='telegram.png' width='25px' height='25px' style={{marginTop:'10px', verticalAlign: 'middle'}}/>
                        </a>
                        &nbsp;&nbsp;&nbsp;
                        <a href='https://vk.com/traektoriamai' target='_blank'>
                          <img src={props.is_builtLetter ? 'https://dev.mai.ru/services/email-creator-tr/images/_vk.png' : process.env.PUBLIC_URL + '/images/_vk.png'}
