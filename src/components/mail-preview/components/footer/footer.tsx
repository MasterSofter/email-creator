export default function Footer(props: { is_builtLetter: boolean; }): JSX.Element {
    return (
      <table border={0} cellSpacing={0} cellPadding={0} width='100%' style={{borderCollapse:'collapse', padding:0, minWidth:'375px', maxWidth:'600px', marginTop:'15px', marginBottom:'15px', marginLeft: 'auto' ,marginRight: 'auto'}}>
        <tbody>
          <tr>
            <td>
              <table align='center' border={0} cellSpacing={0} cellPadding={0} role='presentation' style={{width: '100%', minWidth:'375px', maxWidth:'600px', marginTop:'15px', marginBottom: '30px'}}>
                <tbody>
                <tr style={{margin: 0, padding: 0}}>
                  <td style={{margin: 0, padding: 0, display: 'flex', flexDirection:'row'}}>
                    ...
                    <div style={{display: 'inline-block', verticalAlign: 'top', width: '100%', maxWidth:'450px'}}>
                ...
                <tr style={{margin: 0, padding: 0}}>
                  <td style={{margin: 0, padding: 0, display: 'flex', flexDirection:'row'}}>
                    ...
                    <div style={{display: 'inline-block', verticalAlign: 'top', width: '100%', maxWidth:'450px'}}>
                      <a href='traektoria@mai.ru' style={{display: 'block', color: 'rgb(0,0,0)', fontSize: '13px', lineHeight: '28px', fontWeight: 'normal', textAlign: 'right', textDecoration: 'none', paddingBottom: '0px'}}>
                        traektoria@mai.ru&nbsp;&nbsp;
