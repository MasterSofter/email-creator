...
<div align="center">
  ...
  <h1 align="center">Email шаблонизатор</h1>
</div>

---
## Руководство по работе с проектом

Данный проект создан с помощью [Create React App](https://github.com/facebook/create-react-app) с TypeScript командой: 

```bash
npx create-react-app email-creator --template typescript
```
